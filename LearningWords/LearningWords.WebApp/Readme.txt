...
dotnet ef migrations add -p Common.Data.Migrations --startup-project LearningWords.WebApp -o Migrations -c WordsDbContext InitialCreate

Обновление миграций:
dotnet ef database update -p LearningWords.WebApp --startup-project LearningWords.WebApp -c ApplicationDbContext
dotnet ef database update -p LearningWords.WebApp --startup-project LearningWords.WebApp -c WordsDbContext
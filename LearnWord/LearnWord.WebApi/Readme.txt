...
dotnet ef migrations add -p LearnWord.Identity.Migrations --startup-project LearnWord.Identity -o Migrations -c CollectionIdentityDbContext InitialCreate
...
dotnet ef database update -p LearnWord.Identity --startup-project LearnWord.Identity -c CollectionIdentityDbContext
